# Conhecimento do cliente — <Nome do Cliente>
...
- Org: produção em `<alias-prod>` (agente nunca toca), sandbox de trabalho em `<alias-sandbox>`
...
(o que é relevante o agente saber para não propor algo fora do contexto do cliente)
