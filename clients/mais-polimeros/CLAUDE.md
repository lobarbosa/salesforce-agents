# Conhecimento do cliente — Mais Polímeros
...
- Sandboxes da esteira (aliases `sbx-mais-polimeros-dev` e `sbx-mais-polimeros-qa`, Environments
  `mais-polimeros-dev` e `mais-polimeros-qa`):
